...
public class Combate {
	...
	public void combateFacilPortaDireita(int armaJogador, int modoDeAndar, String escolhaMotivacao,
			String classeCombate, int escolhaSeguimentoJogo) {
